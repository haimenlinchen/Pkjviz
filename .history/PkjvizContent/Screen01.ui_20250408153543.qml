                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            id: onlineTools
                            Layout.fillWidth: true
                            Layout.preferredHeight: (switchButton.mode === 0 || switchButton.mode === 1) ? (isCollapsed ? 30 : onlineToolsResizeHandle.toolsHeight) : 0
                            color: "#1e1e1e"
                            ...
                            Rectangle {
                                ...
                                states: [
                                    State {
                                        name: "collapsed"
                                        when: onlineTools.isCollapsed
                                        PropertyChanges {
                                            target: onlineTools
                                            // 已经在collapsed状态时保持collapsed
                                        }
                                    },
                                    State {
                                        name: "expanded"
                                        ...
                                        PropertyChanges {
                                            target: onlineTools
                                            // 已经在expanded状态时保持expanded
                                        }
                                    },
                                    State {
                                        name: "toggle"
                                        when: collapseMouseArea.pressed
                                        PropertyChanges {
                                            target: onlineTools
                                            isCollapsed: !onlineTools.isCollapsed
                                        }
                                        PropertyChanges {
                                            target: onlineToolsResizeHandle
                                            toolsHeight: onlineTools.isCollapsed ? onlineToolsResizeHandle.toolsHeight : 500
                                        }
                                    }
                                ]
                            }
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    Layout.preferredWidth: switchButton.mode === 0 ? (parent.width * 0.3) : 180
                                    Layout.fillHeight: true
                                    color: "#252526"
                                ...
                                Rectangle {
                                    Layout.preferredWidth: switchButton.mode === 0 ? (parent.width * 0.7) : parent.width
                                    Layout.fillHeight: true
                                    color: "#252526"
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Text {
                    ...
                    text: switchButton.mode === 1 ? "发包工具高度: " + onlineToolsResizeHandle.toolsHeight + "px" : "编辑器高度: " + onlineToolsResizeHandle.toolsHeight + "px"
                }
