...
Rectangle {
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        TextArea {
                            ...
                            onFocusChanged: {
                                if (focus && switchButton.checked && onlineToolsResizeHandle.toolsHeight > parent.height - 200) {
                                    onlineToolsResizeHandle.toolsHeight = Math.max(onlineToolsResizeHandle.minHeight, parent.height - 200)
                                }
                            }
                        }
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onMouseYChanged: {
                if(pressed) {
                    var newHeight = Math.max(onlineToolsResizeHandle.minHeight, 
                                        Math.min(onlineToolsResizeHandle.maxHeight, 
                                             -onlineToolsResizeHandle.y))
