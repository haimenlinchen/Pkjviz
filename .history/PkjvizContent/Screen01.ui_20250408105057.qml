...
Rectangle {
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        TextArea {
                            ...
                            onShouldAdjustHeightChanged: if (shouldAdjustHeight) onlineToolsResizeHandle.toolsHeight = Math.max(onlineToolsResizeHandle.minHeight, editorArea.height - 200)
                        }
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onMouseYChanged: {
                if (pressed) {
                    var newHeight = Math.max(onlineToolsResizeHandle.minHeight, Math.min(onlineToolsResizeHandle.maxHeight, -onlineToolsResizeHandle.y));
