                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            id: onlineTools
                            Layout.fillWidth: true
                            Layout.preferredHeight: (switchButton.mode === 0 || switchButton.mode === 1) ? 
                                                   (isCollapsed ? 30 : 
                                                   (switchButton.mode === 0 ? 
                                                   (editorsCollapsed ? 30 : onlineToolsResizeHandle.toolsHeight) : 
                                                   (onlineToolsCollapsed ? 30 : onlineToolsResizeHandle.toolsHeight))) : 0
                            color: "#1e1e1e"
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Text {
                    ...
                    text: switchButton.mode === 1 ? 
                          (onlineTools.onlineToolsCollapsed ? "发包工具已收起" : "发包工具高度: " + onlineToolsResizeHandle.toolsHeight + "px") : 
                          (onlineTools.editorsCollapsed ? "编辑器已收起" : "编辑器高度: " + onlineToolsResizeHandle.toolsHeight + "px")
                }
