                        ...
                        Rectangle {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    property bool isCollapsed: onlineTools.isCollapsed

                                    // 当鼠标悬停时更新折叠状态
                                    property bool shouldToggle: !isHovered && isCollapsed
                                    onShouldToggleChanged: {
                                        if (shouldToggle) {
                                            onlineTools.isCollapsed = false;
                                            onlineToolsResizeHandle.toolsHeight = 500;  // 恢复之前的高度
                                        }
                                    }
                                }
                            }
