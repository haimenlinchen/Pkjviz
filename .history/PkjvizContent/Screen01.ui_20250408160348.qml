                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    ColumnLayout {
                                        ...
                                        Rectangle {
                                            Layout.fillWidth: true
                                            Layout.preferredHeight: deviceListView.currentIndex >= 0 ? 120 : 0
                                            visible: deviceListView.currentIndex >= 0 && !onlineTools.onlineToolsCollapsed
                                            color: "#252526"
                                            ...
                                            ColumnLayout {
                                                ...
                                                Text {
                                                    Layout.fillWidth: true
                                                    color: "#cccccc"
                                                    text: "连接设备: " + (deviceListView.currentIndex >= 0 ? deviceListView.model[deviceListView.currentIndex] : "")
                                                    font.bold: true
                                                    elide: Text.ElideRight
                                                }
