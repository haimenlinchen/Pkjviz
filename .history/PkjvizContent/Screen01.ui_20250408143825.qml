                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                ListView {
                                    Layout.fillWidth: true
                                    Layout.fillHeight: true
                                    model: ["acl_arp_acl", "acl_dot1_qos", "vxlan_decap", "mpls_basic_decap", "uc_vlan_ipv"]
                                    delegate: Rectangle {
                                        width: parent.width
                                        height: 30
                                        color: "transparent"
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            id: onlineTools
                            Layout.fillWidth: true
                            Layout.preferredHeight: switchButton.mode === 1 ? (onlineToolsResizeHandle.toolsHeight) : 0
                            color: "#1e1e1e"
                            visible: switchButton.mode === 1  // 只在在线模式下可见
