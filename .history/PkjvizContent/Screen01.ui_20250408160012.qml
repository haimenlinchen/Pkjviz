                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    ColumnLayout {
                                        ...
                                        ListView {
                                            ...
                                            delegate: Rectangle {
                                                ...
                                                MouseArea {
                                                    anchors.fill: parent
                                                    hoverEnabled: true
                                                    onEntered: if (!ListView.isCurrentItem) parent.color = "#2a2d2e"
                                                    onExited: if (!ListView.isCurrentItem) parent.color = "transparent"
                                                    onClicked: {
                                                        ListView.view.currentIndex = index
                                                        onlineTools.selectedDevice = modelData
                                                    }
                                                }
                                            }
                                        }
                                        ...
                                        Rectangle {
                                            Layout.fillWidth: true
                                            Layout.preferredHeight: onlineTools.selectedDevice ? 120 : 0
                                            visible: onlineTools.selectedDevice && !onlineTools.onlineToolsCollapsed
                                            color: "#252526"
                                            ...
                                            ColumnLayout {
                                                ...
                                                Text {
                                                    Layout.fillWidth: true
                                                    color: "#cccccc"
                                                    text: "连接设备: " + onlineTools.selectedDevice
                                                    font.bold: true
                                                    elide: Text.ElideRight
                                                }
                                                ...
                                                Button {
                                                    ...
                                                    onClicked: {
                                                        // 这里添加连接设备的逻辑
                                                        console.log("正在连接设备:", onlineTools.selectedDevice)
