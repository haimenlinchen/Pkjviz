        ...
        Rectangle {
            ...
            Row {
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            onActivated: {
                                ...
                                // 根据选择的模式更新界面
                                if (secondSelectionBox.currentText === "dut") {
                                    if (moduleSelector.currentText === "Cosim") {
                                        // 显示Cosim特有的字段
                                        ipInput.text = "";
                                        usernameInput.text = "";
                                        passwordInput.text = "";
                                        portInput.text = "22";
                                    } else if (moduleSelector.currentText === "NB_SDK") {
                                        // 显示NB_SDK特有的字段
                                        ipInput.text = "";
                                        usernameInput.text = "";
                                        passwordInput.text = "";
                                        portInput.text = "22";
                                    } else if (moduleSelector.currentText === "Lightning") {
                                        // 显示Lightning特有的字段
                                        ipInput.text = "";
                                        usernameInput.text = "";
                                        passwordInput.text = "";
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            onActivated: {
                                ...
                                // 根据选择显示不同的界面元素
                                protocolSelector.visible = secondSelectionBox.currentText === "demo";
                                confirmButton.visible = secondSelectionBox.currentText === "demo";
                                offlineContainer.visible = secondSelectionBox.currentText === "offline";
                                dutContainer.visible = secondSelectionBox.currentText === "dut";

                                // 针对Cosim和NB_SDK类型，根据平台显示不同的输入框
                                if (secondSelectionBox.currentText === "dut") {
                                    if (moduleSelector.currentText === "Cosim") {
                                        // 显示Cosim特有的字段
                                        ipInput.text = "";
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            onActivated: {
                                console.log("选择的协议: " + protocolBox.currentText);
                            }
                        }
                    }
                }
                ...
                Button {
                    ...
                    onClicked: {
                        console.log("确认按钮被点击");
                        console.log("模式: " + moduleSelector.currentText);
                        console.log("类型: " + secondSelectionBox.currentText);
                        console.log("协议: " + protocolBox.currentText);
                    }
                }
            ...
            ColumnLayout {
                ...
                Button {
                    ...
                    onClicked: {
                        console.log("连接按钮被点击");
                        console.log("模式: " + moduleSelector.currentText);
                        console.log("IP: " + ipInput.text);
                        console.log("端口: " + portInput.text);
